...
type Product struct {
	...
	Type            int64            `json:"type" gorm:"column:type"`                                     // 商品类型ID
	...
	ShowStyle       int              `json:"show_style" gorm:"default:1"`                                 // 显示样式
	APIFailStyle    int              `json:"api_fail_style" gorm:"default:1"`                             // API失败处理方式
	...
	APIID           int64            `json:"api_id"`                                                      // API接口ID
	APIParamID      int64            `json:"api_param_id"`                                                // API参数ID
	...
	Category        *ProductCategory `json:"category,omitempty" gorm:"foreignKey:CategoryID"`             // 关联的商品分类
}
