...
class Test
{
...

    {
        die;
        $ql = new QueryList();
        $url = "http://mf.onetar.top/yrapi.php/open/voucher/id/23085.html";
...
// 获取页面html内容
        ...
        die;
        echo $this->getWebTag ( 'id="img"', 'http://mf.onetar.top/yrapi.php/open/voucher/id/23085.html', 'div' );
        die;
        $str =file_get_contents('http://mf.onetar.top/yrapi.php/open/voucher/id/23085.html');
