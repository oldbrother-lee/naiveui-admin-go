    ...
    public function getplan()
    {
        ...
        foreach ($work as $key =>$value) {
            ...
            if($value['way'] == 2){
                ...
                $orders = array(
                    array(
    "accountLocation"=>"江西赣州",
    "accountNum"=> "18279768739",
    "channelId"=>2,
    "channelName"=>"活动话费API",
    "createTime"=> "1731417161000",
    "expectedSettlementTime"=>NULL,
    "expirationTime"=>"1731418961000",
    "faceValue"=>50,
    "orderNumber"=> "42202411124000001105328",
    "orderStatus"=>5,
    "productId"=>6,
    "productName"=>"中国移动",
    "settlementAmount"=>50.2,
    "settlementStatus"=>1,
    "settlementTime"=>NULL
  )
                    );
