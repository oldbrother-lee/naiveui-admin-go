<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/www/wwwroot/115.126.57.143/public/../application/admin/view/daichongs/alladdwork.html";i:1705243000;s:69:"/www/wwwroot/115.126.57.143/application/admin/view/public/header.html";i:1655264244;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" action="<?php echo U(''); ?>">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="work_id" value="<?php echo $info['id']; ?>">
                            <div class="col-sm-4">
