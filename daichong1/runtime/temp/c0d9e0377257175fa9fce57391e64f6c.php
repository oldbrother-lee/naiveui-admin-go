<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/115.126.57.143/public/../application/admin/view/qudan/member.html";i:1728223198;s:69:"/www/wwwroot/115.126.57.143/application/admin/view/public/header.html";i:1655264244;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-title">
                    <div class="col-sm-7 m-b-xs">
                        <a class="btn btn-primary open-window no-refresh btn-sm"
                           href="<?php echo U('add',array('pid'=>I('get.pid',0),'module'=>'')); ?>"><i
                                class="fa fa-plus"></i> 新增</a>
                        <a class="btn btn-primary open-window no-refresh btn-sm"
                           href="<?php echo U('yjtb',array('pid'=>I('get.pid',0),'module'=>'')); ?>"><i
                                class="fa fa-plus"></i> 一键同步</a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $member['app_key']; ?>
                                </td>
                                <td><?php echo $member['app_secret']; ?></td>
                                <td><?php echo $member['vender_id']; ?></td>
                                <td><?php echo $member['operator_id']; ?></td>
                                <td><?php echo $member['prov_code']; ?></td>
                                <td><?php echo $member['amount']; ?></td>
                                <td><?php echo $member['order_num']; ?></td>
                                <td><?php echo $member['date_add']; ?></td>
                                <td>
                                    <a class="open-window no-refresh" title="修改"
                                       href="<?php echo U('add?id='.$member['id']); ?>">修改</a>
