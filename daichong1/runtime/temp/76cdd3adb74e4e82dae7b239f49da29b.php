<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/www/wwwroot/115.126.57.143/public/../application/admin/view/qudan/add.html";i:1728222480;s:69:"/www/wwwroot/115.126.57.143/application/admin/view/public/header.html";i:1655264244;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form role="form" action="<?php echo U(); ?>" method="post" class="menu_form form-horizontal">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <label>userid</label>
                                <input type="text" placeholder="请输入userid" class="form-control" name="userid"
                                       value="<?php echo (isset($info['userid']) && ($info['userid'] !== '')?$info['userid']:''); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
                                <label>app_key</label>
                                <input type="text" placeholder="请输入app_key" class="form-control" name="app_key"
                                       value="<?php echo (isset($info['app_key']) && ($info['app_key'] !== '')?$info['app_key']:0); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
                                <label>app_secret</label>
                                <input type="text" placeholder="" class="form-control" name="app_secret"
                                       value="<?php echo (isset($info['app_secret']) && ($info['app_secret'] !== '')?$info['app_secret']:''); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
