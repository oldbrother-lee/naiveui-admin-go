<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/115.126.57.143/public/../application/agent/view/login/login.html";i:1655264246;}*/ ?>
<!-- lq      -->
<!DOCTYPE html>
<html lang="zh">
<head>
    ...
    <link href="/public/agent/css/font-awesome.css" rel="stylesheet">

    <link href="/public/agent/css/animate.css" rel="stylesheet">
    <link href="/public/agent/css/style.css" rel="stylesheet">
    <!--[if lt IE 9]>
...
<!--            <h1 class="logo-name">DR</h1>-->
            <img src="<?php echo C('SYS_LOGO')?C('SYS_LOGO'):'/public/agent/img/logo.png'; ?>" style="width: 200px;height: auto;"/>
        </div>
        <h3>欢迎使用 <?php echo C('WEB_SITE_TITLE'); ?> 代理端</h3>
...
<script src="/public/agent/js/plugins/validate/jquery.validate.min.js"></script>
<script src="/public/agent/js/plugins/validate/messages_zh.min.js"></script>
<script src="/public/agent/js/plugins/layer/layer.min.js"></script>
<script src="/public/agent/js/particles.min.js"></script>
</body>
<script>
    $(function () {
