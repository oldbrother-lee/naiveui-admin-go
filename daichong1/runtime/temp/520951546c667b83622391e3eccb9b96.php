<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/115.126.57.143/public/../application/agent/view/admin/index.html";i:1655264246;}*/ ?>
<!-- lq      -->
<!DOCTYPE html>
<html>
<head>
    ...
    <link href="/public/agent/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
    <link href="/public/agent/css/animate.css" rel="stylesheet">
    <link href="/public/agent/css/style.css?v=111" rel="stylesheet">
...
<div id="wrapper">
                    ...
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"><span class="block m-t-xs"><strong
                                    class="font-bold"><?php echo $user['username']; ?></strong></span></span>
                            <span class="text-muted text-xs block">更多操作<b
                                    class="caret"></b></span>
                            </span>
                        </a>
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a class="J_menuItem" href="<?php echo url('User/infos'); ?>">我的资料</a>
                            </li>
                            <li class="divider"></li>
    ...
    <!--左侧导航结束-->
    <!--右侧部分开始-->
    <div id="page-wrapper" class="gray-bg dashbard-1" style="position: relative;">
...
<script src="/public/agent/js/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="/public/agent/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="/public/agent/js/plugins/layer/layer.min.js"></script>

<!-- 自定义js -->
<script src="/public/agent/js/hplus.js?v11"></script>
<script type="text/javascript" src="/public/agent/js/contabs.js"></script>

<!-- 第三方插件 -->
<script src="/public/agent/js/plugins/pace/pace.min.js"></script>
