<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/www/wwwroot/daichong1/public/../application/admin/view/daichongs/add.html";i:1731074051;s:64:"/www/wwwroot/daichong1/application/admin/view/public/header.html";i:1655264244;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                              ...
                              <div class="col-sm-4">
                                ...
                                <select name="way" class="form-control m-b">
                                    <option value="1" <?php if(1 == $info['way']){ echo "selected"; } ?>>小蜜蜂</option>
                                    <option value="2" <?php if(2 == $info['way']){ echo "selected"; } ?>>闲赚侠</option>
                                </select>
                            </div>
                            <!--<div class="col-sm-4">-->
