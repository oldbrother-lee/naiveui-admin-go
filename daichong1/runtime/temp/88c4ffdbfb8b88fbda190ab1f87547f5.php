<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/daichong1/public/../application/admin/view/daichongs/addwork.html";i:1731245271;s:64:"/www/wwwroot/daichong1/application/admin/view/public/header.html";i:1655264244;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<!--                                <span class="input-group-btn"><button id="updateAreaBtn" type="button" class="btn btn-sm btn-info ">更新地区</button></span>-->
                            ...
                            <div class="col-sm-4">
                             ...
                             <div class="col-sm-4">
                                <label>最低结算价<span style="margin-left: 8px;color: #aaa;"></span></label>
                                 <input name="minSettleAmounts" type="text" class="form-control" value="<?php echo $info['minSettleAmounts']; ?>">
                            </div>
                        </div>
