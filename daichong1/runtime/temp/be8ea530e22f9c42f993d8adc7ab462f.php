<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/www/wwwroot/daichong1/public/../application/admin/view/daichongs/mian.html";i:1731048639;s:64:"/www/wwwroot/daichong1/application/admin/view/public/header.html";i:1655264244;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<!--                                <a class="btn btn-sm btn-primary open-window" title="账号列表" href="<?php echo U('userlist'); ?>"><i-->
...
<!--&lt;!&ndash;                                           value="<?php echo $user['money']; ?>">&ndash;&gt;-->
<!--&lt;!&ndash;                                    <span class="input-group-btn">&ndash;&gt;-->
<!--&lt;!&ndash;                                            <button type="button"&ndash;&gt;-->
<!--&lt;!&ndash;                                                    class="btn btn-sm btn-info ">元</button> </span>&ndash;&gt;-->

<!--                                    <a href="javascript:setmoney(10)" class="btn btn-sm <?php if($user['money10'] == '1'): ?>btn-warning<?php else: ?>btn-primary<?php endif; ?>  "   title=""-->
<!--                                    style="padding: 4px 12px;" type="button">10</a>-->
<!--                                    <a href="javascript:setmoney(20)" class="btn btn-sm <?php if($user['money20'] == '1'): ?>btn-warning<?php else: ?>btn-primary<?php endif; ?>  "   title=""-->
...
<!--                            </div>-->
                            ...
                            <div class="form-group">
                                <a href="javascript:void(0)" class="btn btn-sm btn-primary ladan" <?php if($is_getplan == 0): ?> theval="1"<?php else: ?>theval="0"<?php endif; ?>  title="开始拉单"
                            ...
                            <div class="form-group">
                                <a href="javascript:void(0)" class="btn btn-sm btn-primary paifa" <?php if($is_pf == 0): ?> theval="1"<?php else: ?>theval="0"<?php endif; ?>  title="清理数据"
                                   style="padding: 4px 12px;" type="button">
                                    <?php if($is_pf == 0): ?>
                                    开启派发
                                    <?php else: ?>
                            ...
                            <div class="form-group">
                                <a href="javascript:void(0)" class="btn btn-sm btn-primary xzx" <?php if($is_xzx == 0): ?> theval="1"<?php else: ?>theval="0"<?php endif; ?>  title="闲赚侠拉单"
                                style="padding: 4px 12px;" type="button">
                                <?php if($is_xzx == 0): ?>
                                闲赚侠开启拉单
                                <?php else: ?>
...
<script>
    ...
    function getplan(){
        ...
        var url = "<?php echo url('daichongs/getplan'); ?>";
    ...
    function setmoneysss(e){
        ...
        var url = "<?php echo url('daichongs/zidonghua'); ?>";
    ...
    function setmoney(e){
        ...
        var url = "<?php echo url('daichongs/moneyset'); ?>";
        $.get(url+"?money=money"+e,function(data,status){
            if(data.code==1){
                layer.msg(e+'金额设置成功！');
    ...
    $('.sjqingli').click(function () {
        ...
        var url = "<?php echo url('daichongs/deall'); ?>";
    ...
    $('.paifa').click(function(){
        ...
        // alert(val);
        var url = "<?php echo url('daichongs/setpf'); ?>";
        // alert(url);return;
     ...
     $('.xzx').click(function(){
        var val = $(this).attr('theval');
        // alert(val);
        var url = "<?php echo url('daichongs/setxzx'); ?>";
        // alert(url);return;
        $.get(url+'?val='+val,function(data,status){
              if(data.errno == 0){
               location.reload();
    ...
    $('#baocun').click(function () {
       ...
       if(pwd.length<1){
        ...
        var url = "<?php echo url('login/newdaichonglog'); ?>";
    ...
    $(".ladan").click(function(){
         var val = $(this).attr('theval');
         var url = "<?php echo url('daichongs/setgetplan'); ?>";
        $.get(url+'?val='+val,function(data,status){
              if(data.errno == 0){
               location.reload();
              }
    ...
    $('#qd').click(function () {
        ...
        if(txt=='停止程序'){
            ...
            //停止操作
            var url = "<?php echo url('daichongs/stop'); ?>";
            $.get(url,function(data,status){
                if(data.code==1){
                    layer.msg('系统停止成功！');
                }else{
            ...
            //启动操作
            var url = "<?php echo url('daichongs/start'); ?>";
